-- 🔐 Migration de sécurité et optimisation MedCollab v2
-- Cette migration corrige les vulnérabilités critiques sans conflits

-- 🔔 1. Système de notifications natifs amélioré
...
-- ✅ 8. Validation et contraintes de sécurité (avec IF NOT EXISTS)
DO $$
BEGIN
  IF NOT EXISTS (
...
-- 🔄 10. Finalisation avec commentaires de documentation
...
SELECT 'Migration de sécurité et optimisation MedCollab v2 terminée' as status;