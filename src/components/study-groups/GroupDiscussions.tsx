...
const GroupDiscussions: React.FC<GroupDiscussionsProps> = ({ groupId, userRole }) => {
  ...
  useEffect(() => {
    ...
    const fetchMessages = async () => {
      setIsLoading(true);
      try {
        // This would be a table like "group_messages" in a real implementation
        ...
        const formattedMessages = data?.map(msg => ({
          ...
          user_id: msg.user_id,
          sender_name: msg.profiles?.display_name || 'Utilisateur',
          sender_avatar: msg.profiles?.profile_image
        })) || [];
        
        setMessages(formattedMessages);
      } catch (error) {
        console.error('Error fetching messages:', error);
        // Since group_messages might not exist yet, we'll just show an empty state
        setMessages([]);
      } finally {
        setIsLoading(false);
      }
    ...
    // Subscribe to new messages (would be implemented in a real-time app)
