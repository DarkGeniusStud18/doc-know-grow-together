...
export const musicCategories: MusicCategory[] = [
  {
    ...
    tracks: [
      ...
      },
      {
        ...
        audioUrl: 'https://cdn.pixabay.com/audio/2022/01/20/audio_d0fd068033.mp3',
        duration: '4:15',
        bpm: 75,
      ...
      },
      {
        ...
        audioUrl: 'https://cdn.pixabay.com/audio/2021/11/25/audio_cb4f1212a9.mp3',
        duration: '3:58',
        bpm: 85,
    ...
    tracks: [
      {
        ...
        audioUrl: 'https://cdn.pixabay.com/audio/2021/04/07/audio_615cf64e1a.mp3',
        duration: '5:24',
      ...
      },
      {
        ...
        audioUrl: 'https://cdn.pixabay.com/audio/2022/03/09/audio_30bf7a39ce.mp3',
        duration: '6:10',
      ...
      },
      {
        ...
        audioUrl: 'https://cdn.pixabay.com/audio/2022/01/18/audio_d16737dc28.mp3',
        duration: '5:45',
    ...
    tracks: [
      {
        ...
        audioUrl: 'https://cdn.pixabay.com/audio/2022/01/26/audio_d6ecde8420.mp3',
        duration: '5:46',
      ...
      },
      {
        ...
        audioUrl: 'https://cdn.pixabay.com/audio/2022/03/15/audio_c877851825.mp3',
        duration: '4:40',
      ...
      },
      {
        ...
        audioUrl: 'https://cdn.pixabay.com/audio/2022/05/13/audio_8fcf7a13aa.mp3',
        duration: '5:12',
    ...
    tracks: [
      {
        ...
        audioUrl: 'https://cdn.pixabay.com/audio/2022/05/16/audio_1955326866.mp3',
        duration: '4:20',
        bpm: 60,
      ...
      },
      {
        ...
        audioUrl: 'https://cdn.pixabay.com/audio/2022/10/30/audio_946bc8e082.mp3',
        duration: '7:15',
      ...
      },
      {
        ...
        audioUrl: 'https://cdn.pixabay.com/audio/2022/10/03/audio_95db42a1d5.mp3',
        duration: '6:30',
        bpm: 65,
    ...
    tracks: [
      {
        ...
        audioUrl: 'https://cdn.pixabay.com/audio/2022/03/15/audio_c43e44c783.mp3',
        duration: '3:45',
        bpm: 95,
      ...
      },
      {
        ...
        audioUrl: 'https://cdn.pixabay.com/audio/2022/05/17/audio_89dade64aa.mp3',
        duration: '4:12',
        bpm: 88,
      ...
      },
      {
        ...
        audioUrl: 'https://cdn.pixabay.com/audio/2021/12/12/audio_454e93808e.mp3',
        duration: '3:50',
        bpm: 100,
